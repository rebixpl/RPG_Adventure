...
namespace RPG_Adventure
{
    public class ReplaceWithRagdoll : MonoBehaviour
    {
        ...
        //public void Replace()
        //{
        //    // Create new ragdoll instance at the same position and rotation as original
        //    GameObject ragdolInstance = Instantiate(ragdollPrefab, transform.position, transform.rotation);

        //    // Iterate over all children of transform and copy positions and rotation to a ragdoll
